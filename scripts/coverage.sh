...
#
# The gate measures ./pkg/... (the business logic: aggregation, the SR decode,
# the consumer fold/error semantics, and the HTTP surface). It deliberately
# excludes two surfaces that cannot be unit-tested without a live cluster and
...
# the running obs-svc-agg container against live delight.events, not in CI.
#
